...
export const stageObstacles: ObstacleParams[] = [
    ...
    { point: { x: 550, y: 1210 }, w: 40, h: 80, options: { tag: "ground", bounciness: bounciness } },
    { point: { x: 490, y: 840 }, w: 160, h: 40, options: { tag: "ground", bounciness: bounciness } },
    { point: { x: 430, y: 1100 }, w: 40, h: 320, options: { tag: "ground", bounciness: bounciness } },
    { point: { x: 490, y: 1250 }, w: 120, h: 40, options: { tag: "ground", bounciness: bounciness } },
